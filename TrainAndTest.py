...
def readcsv(rownum):
    ...
    imgROIResized = cv2.resize(num_data[rownum], (RESIZED_IMAGE_WIDTH, RESIZED_IMAGE_HEIGHT))             # resize image, this will be more consistent for recognition and storage
    print(imgROIResized)
